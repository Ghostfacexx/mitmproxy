...
CURRENCY_TRANSACTION_PATTERNS: dict[str, dict[str, list[int] | int | list[str]] | dict[str, list[float] | float | list[str]] | dict[str, list[float] | float | list[str]] | dict[str, list[float] | float | list[str]]] = {
    'USD': {
...
class CountryCurrencyLookup:
    ...
    def get_country_info(self, country_code: Optional[str]) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_currency_info(self, currency_code: Optional[str]) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            if currency_code is None:
                logger.warning("Currency code is None")
                return None
