...
# Add project root to path, ensuring correct directory
project_root = Path(__file__).parent.parent  # Move up to 'gateimplement' directory
...
def test_mitm_live_interception():
    ...
    try:
        ...
        from pathlib import Path
        config_path = Path(r"C:\Users\PC\Downloads\gateimpl\gateimplement\src\mitm\config\mitm_config.json")
        mitm = RealTransactionMITM(config_path=str(config_path))
